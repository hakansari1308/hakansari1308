...
namespace Aslanbeyjetdata.Concrete
{
    public static class SeedDatabase
    {
        ...
        {
            new Guzergah(){ GuzergahId=1, Baslangic="İstanbul", Bitis="Isparta", Tarih="15.05.2021", Saat="18.00", ImageUrl="1.jpg", Fiyat=110},
            new Guzergah(){ GuzergahId=2, Baslangic="Rize",Bitis="İstanbul", Tarih="16.05.2021", Saat="19.00", ImageUrl="3.jpg", Fiyat=180},
            };
